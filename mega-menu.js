...
(function () {
  ...
  const PILLS = {
    ...
    'Industries': [
      { label: 'BFSI & Payments', href: 'solution-bfsi-ai.html' },
      { label: 'Healthcare AI', href: 'solution-healthcare-ai.html' },
      { label: 'Manufacturing', href: 'manufacturing.html', hot: true },
      { label: 'Retail & E-commerce', href: 'retail.html' },
      { label: 'Telecom', href: 'telecom.html' },
      { label: 'Logistics', href: 'logistics.html' },
      { label: 'Government AI', href: 'government.html' },
